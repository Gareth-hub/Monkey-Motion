...
os.chdir('D:\Programming\Monkey Motion\Monkey Motion Game')
...
def game_intro():
    ...
    while intro:
        ...
        button("Start",700,350,100,50,bright_red,red,level_select)
...
def game_controls():
    ...
    while gcont:
        ...
        button("Back",1200,500,100,50,bright_red,red,game_intro)
...
def level_select():
    ...
    while select:
        ...
        button("Level 1",700,350,100,50,bright_red,red,level_1)
        button("Level 2",700,450,100,50,bright_red,red,level_2)
